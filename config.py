...
WEIGHT_CANVAS_HASH = float(os.getenv("WEIGHT_CANVAS_HASH", "0.19"))
WEIGHT_FONTS = float(os.getenv("WEIGHT_FONTS", "0.19"))
WEIGHT_USER_AGENT = float(os.getenv("WEIGHT_USER_AGENT", "0.17"))
WEIGHT_AUDIO_HASH = float(os.getenv("WEIGHT_AUDIO_HASH", "0.15"))
WEIGHT_WEBGL_HASH = float(os.getenv("WEIGHT_WEBGL_HASH", "0.07"))
WEIGHT_IP_INFO = float(os.getenv("WEIGHT_IP_INFO", "0.05"))
